...
When the thread 1 increases the counter variable, but both thread 1 and thread 2 may need to read counter variable from time to time.
...
## Full volatile Visbility Guarantee
